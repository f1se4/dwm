...
//static const char *fonts[]          = { "Ubuntu:size=10", "FontAwesome:size=12", "Noto Color Emoji:pixelsize=12:antialias=true:autohint=true" };
static const char *fonts[]          = { "Hack Nerd Font:style:medium:size=10",
                                        "Material Design Icons-Regular:size=16",
                                      };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_minus,	spawn,		SHCMD("pulsemixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("pulsemixer --allow-boost -d 15; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_equal,	spawn,		SHCMD("pulsemixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_equal,	spawn,		SHCMD("pulsemixer --allow-boost -i 15; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY|ShiftMask,		XK_q,		spawn,		SHCMD("/home/f1se4/.local/bin/qmenu.sh") },
	{ MODKEY,			XK_w,		spawn,		SHCMD("$BROWSER") },
	{ MODKEY|ShiftMask,		XK_w,		spawn,		SHCMD(TERMINAL " -e sudo nmtui") },
	{ MODKEY,			XK_e,		spawn,		SHCMD(TERMINAL " -e neomutt ; pkill -RTMIN+12 dwmblocks") },
	{ MODKEY|ShiftMask,		XK_e,		spawn,		SHCMD(TERMINAL " -e abookk") },
	{ MODKEY,			XK_r,		spawn,		SHCMD(TERMINAL " -e /usr/bin/lfrun") },
	...
	{ MODKEY|ShiftMask,		XK_p,			spawn,		SHCMD("cmus-remote --pause") },
	...
	{ MODKEY|ShiftMask,		XK_bracketright,	spawn,		SHCMD("cmus-remote --seek seek +60") },
	...
	{ MODKEY,			XK_d,		spawn,          SHCMD("rofi -modi run -show drun -show-icons") },
	{ MODKEY|ShiftMask,		XK_d,		spawn,		SHCMD("/home/f1se4/.local/bin/pmenu.sh") },
	...
	{ ShiftMask,			XK_Print,	spawn,		SHCMD("flameshot config") },
	...
	{ 0, XF86XK_AudioMicMute,	spawn,		SHCMD("pactl set-sink-input-mute @DEFAULT_SINK@ toggle") },
	{ 0, XF86XK_PowerOff,		spawn,		SHCMD("sysact") },
	{ 0, XF86XK_Calculator,		spawn,		SHCMD(TERMINAL " -e bc -l") },
	{ 0, XF86XK_Sleep,		spawn,		SHCMD("sudo -A zzz") },
	{ 0, XF86XK_WWW,		spawn,		SHCMD("$BROWSER") },
	{ 0, XF86XK_DOS,		spawn,		SHCMD(TERMINAL) },
	{ 0, XF86XK_ScreenSaver,	spawn,		SHCMD("slock & xset dpms force off; cmus-remote --pause; pauseallmpv") },
